...
echo "=========================================="
echo "취약 웹 서버 배포 및 테스트"
echo "=========================================="
echo ""

# 1. Terraform 배포
echo "[1/5] Terraform 배포 중..."
cd terraform
terraform init
...
# 2. 웹 서버 준비 대기
echo ""
echo "[2/5] 웹 서버 초기화 대기 중 (3분)..."
sleep 180

# 3. 서비스 확인
echo ""
echo "[3/5] 서비스 확인 중..."
echo "Text4shell: http://${WEB_SERVER_IP}:8080/api/test"
...
echo ""
echo "다음 단계:"
echo "  1. 대시보드 실행: streamlit run src/dashboard/app.py"
echo "  2. 브라우저에서 결과 확인"
echo ""
